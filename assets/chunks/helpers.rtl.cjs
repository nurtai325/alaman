 ...
 */ function _getStartAndCountOfVisiblePoints(meta, points, animationsDisabled) {
    ...
    if (meta._sorted) {
        ...
        if (minDefined) {
            ...
            _lookupByKey(_parsed, axis, min).lo, animationsDisabled ? pointCount : _lookupByKey(points, axis, iScale.getPixelForValue(min)).lo);
            if (spanGaps) {
        ...
        if (maxDefined) {
            ...
            _lookupByKey(_parsed, iScale.axis, max, true).hi + 1, animationsDisabled ? 0 : _lookupByKey(points, axis, iScale.getPixelForValue(max), true).hi + 1);
            if (spanGaps) {
...
//# sourceMappingURL=helpers.rtl.cjs.map
